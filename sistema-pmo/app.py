...
# ════════════════════════════════════════════════════════════════════
    ...
    with d2:
        ...
        <div style='background:#FFFFFF;border:1px solid #E5E7EB;border-radius:10px;padding:20px;'>
          ...
          {campo("Orçamento Previsto", f"R$ {orc_prev/1_000_000:.2f} mi".replace(".",","))}
        ...
        if salvar:
            if not nome or not area or not pmo:
                ...
                dados = {
                    ...
                    "aprovado": aprovado,
                    "orcamento_aprovado": orc_aprov,
                    "inicio_previsto": str(inicio) if inicio else None,
                    "fim_previsto": str(fim) if fim else None,
                }
